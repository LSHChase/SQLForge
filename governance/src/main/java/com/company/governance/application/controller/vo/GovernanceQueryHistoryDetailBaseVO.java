...
public class GovernanceQueryHistoryDetailBaseVO {
    ...
    public String getBoundSqlText() { return boundSqlText; }
    public void setBoundSqlText(String boundSqlText) { this.boundSqlText = boundSqlText; }
    ...
    public Map<String, Object> getQueryDateSummary() { return queryDateSummary; }
    public void setQueryDateSummary(Map<String, Object> queryDateSummary) { this.queryDateSummary = queryDateSummary; }
    ...
    public Map<String, Object> getExecutionSummary() { return executionSummary; }
    public void setExecutionSummary(Map<String, Object> executionSummary) { this.executionSummary = executionSummary; }
    public Map<String, Object> getRewriteAudit() { return rewriteAudit; }
    public void setRewriteAudit(Map<String, Object> rewriteAudit) { this.rewriteAudit = rewriteAudit; }
    public Map<String, Object> getStructureParseSummary() { return structureParseSummary; }
    public void setStructureParseSummary(Map<String, Object> structureParseSummary) { this.structureParseSummary = structureParseSummary; }
    public Map<String, Object> getAccessParseSummary() { return accessParseSummary; }
    public void setAccessParseSummary(Map<String, Object> accessParseSummary) { this.accessParseSummary = accessParseSummary; }
    public Map<String, Object> getRouteDecision() { return routeDecision; }
    public void setRouteDecision(Map<String, Object> routeDecision) { this.routeDecision = routeDecision; }
    ...
    public GovernanceTraceDetailVO getTraceDetail() { return traceDetail; }
    public void setTraceDetail(GovernanceTraceDetailVO traceDetail) { this.traceDetail = traceDetail; }
}
