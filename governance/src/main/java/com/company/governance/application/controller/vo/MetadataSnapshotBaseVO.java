...
public class MetadataSnapshotBaseVO {
    ...
    public Integer getUpstreamCount() { return upstreamCount; }

    public void setUpstreamCount(Integer upstreamCount) { this.upstreamCount = upstreamCount; }

    public Integer getDownstreamCount() { return downstreamCount; }

    public void setDownstreamCount(Integer downstreamCount) { this.downstreamCount = downstreamCount; }

    public List<MetadataLineageVO> getUpstreamRefs() { return upstreamRefs; }

    public void setUpstreamRefs(List<MetadataLineageVO> upstreamRefs) { this.upstreamRefs = upstreamRefs; }

    public List<MetadataLineageVO> getDownstreamRefs() { return downstreamRefs; }

    public void setDownstreamRefs(List<MetadataLineageVO> downstreamRefs) { this.downstreamRefs = downstreamRefs; }
