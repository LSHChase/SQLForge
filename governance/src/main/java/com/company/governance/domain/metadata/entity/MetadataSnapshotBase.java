...
public class MetadataSnapshotBase {
    ...
    public MetadataSnapshotBase(String snapshotId,
                            String tenantId,
    ...
    public List<MetadataLineageRef> getUpstreamRefs() { return upstreamRefs; }

    public void setUpstreamRefs(List<MetadataLineageRef> upstreamRefs) { this.upstreamRefs = upstreamRefs; }

    public List<MetadataLineageRef> getDownstreamRefs() { return downstreamRefs; }

    public void setDownstreamRefs(List<MetadataLineageRef> downstreamRefs) { this.downstreamRefs = downstreamRefs; }
}
