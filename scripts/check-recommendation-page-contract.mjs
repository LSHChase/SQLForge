...
const targets = [
  {
    ...
    tokens: [
      ...
      'data-testid="recommendation-rewrite-activation-eligibility"',
      ...
      'data-testid="recommendation-real-mv-create-result"',
      'data-testid="recommendation-real-mv-create-evidence"',
      'createMaterializedView',
      'createRealMaterializedView',
      'canCreateMaterializedView',
      'materializedViewCreateResultCards',
      'frontend-recommendation-real-materialized-view-create',
      'coordinationMode',
      'PULL_ONLY',
      'dispatchEvents',
      'benefitLevel',
      ...
      'buildRewriteValidationRunPayload',
      'createValidationRunForSelectedRewrite',
      'approveRewriteAutoApply',
      'frontend-recommendation-rewrite-validation-run-create',
      'frontend-recommendation-rewrite-review-approve',
      'activationStatus',
      'activationEligibilityCards',
  ...
  },
  {
    ...
    tokens: [
      ...
      'pauseSqlRewriteRecord',
      'createMaterializedView',
      '/api/sql-optimization/recommendations/${encodeURIComponent(recommendationId)}/materialized-view/create',
      '/api/sql-optimization/rewrite-records/${encodeURIComponent(rewriteRecordId)}/activation-eligibility',
      ...
      '/api/sql-optimization/rewrite-records/${encodeURIComponent(rewriteRecordId)}/activate',
...
function assertAmv013DisplayContract() {
  ...
  assert(
    ...
    'AMV-016 REVIEW_REQUIRED artifact must not become automatic runtime rewrite SQL source.'
  )
