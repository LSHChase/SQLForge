...
### INBOX-008: 是否破坏性删除或弱化 R111-R115 与 R118 核心安全合规规则

- Status: open
- Needed decision: 本轮已清理 `R-014`、`R-055`、`R-110`、`R-139` 的非核心或过时消费语义；但 `R-111` 至 `R-115` 与 `R-118` 直接影响身份鉴别、租户访问控制、审计历史、敏感字段加密、备份恢复和阶段合规验证。请选择 A）保留最小执行安全内核，仅清理产品化辅助治理面解释（推荐）；B）把 `R-111` 至 `R-115` / `R-118` 重写为更窄的执行引擎安全规则，但保留身份、租户、历史、加密、备份和验证替代项；C）删除或大幅弱化上述核心规则，并明确接受安全、审计、合规和恢复风险。
- Task refs: USER-CN-RULE-CLEANUP-R014-R055-R110-R115-R118-R139-20260520
- Plan refs: docs/plans/rule-cleanup-r014-r055-r110-r115-r118-r139-impact-analysis-2026-05-20.md
