...
- 当前活跃目标：按仓库真值收口已被部分消费的部署与恢复文档任务
- 当前下一条可执行主线任务：
  - `F-TASK-001`
- 说明：
  ...
  - `E-TASK-004`、`E-TASK-005`、`E-TASK-006` 已按 repository truth 完成前端路由、能力接入和设计系统三项归档；当前主线切到 `F-TASK-001` 至 `F-TASK-003`，对部署文档、compose/脚本说明与恢复提醒做同类真值修正。
