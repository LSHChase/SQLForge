...
| `HARN-133` | 若候选入口会混淆解析证据和真实运行指标、放宽 sourceType/sourceId 校验或跨租户聚合，需人工确认。 | acceleration candidate、source evidence、runtime evidence 与追溯键。 | 停用候选生成入口，恢复原优化任务和加速计划独立流程。 |
