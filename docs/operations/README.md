...
4. [Requirements-To-Task Playbook](./requirements-to-task-playbook.md)
   从无 task 开始的治理自动化入口，定义 Codex 日常输入模板、`governed_intake`、`governed_healthcheck`、requirement normalization、candidate task pack、materialization gate 与 `governed_full_cycle` 流程。
