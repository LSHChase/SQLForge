export default {
  ...
  inline: {
    ...
    viewsDashboardDashboardView: {
      text001: '仅展示已审计证据',
      text002: '解析 SQL 样本',
      text003: '来自 parse-statistics overview 的当前总览样本。',
      text004: '成功率样本',
      text005: '来自当前 query-history 窗口，而不是租户全量历史。',
      text006: '失败率样本',
      text007: '只基于当前窗口结果状态，不夸大为完整失败总量。',
      text008: '缓存命中样本',
      text009: '只消费当前历史窗口中的 cacheHit 字段。',
      text010: '轻量改写样本',
      text011: '当前窗口里已应用 rewrite 的 SQL 样本占比。',
      text012: '加速命中样本',
      text013: '当前窗口里 accelerationApplied=true 的样本比例。',
      text014: '问题 SQL',
      text015: '直接展示问题 SQL 与当前样本占比。',
      text016: '重要 / 紧急',
      text017: '来自 important-urgent 聚合，不在前端重算优先级。',
      text018: '治理 backlog',
      text019: '基于治理管理消息统计中的 pending + failed。',
      text020: '深度建议样本',
      text021: '当前可见 recommendation 数量已知，但采纳率仍缺专用后端聚合。',
      text022: '装数协同状态',
      text023: '当前仓库只承诺 PULL_ONLY 协同，不伪装主动推送或真实装数。',
      text024: '告警样本',
      text025: '由失败消息、dispatch 失败、紧急 SQL 和高风险建议派生。',
      text026: '接入方式样本',
      text027: '来自 query-history 当前窗口的 accessChannel 分布样本。',
      text028: '主路由引擎样本',
      text029: '基于 query-history 当前页目标引擎样本，不冒充全租户分布。',
      text030: '查询工作台',
      text031: '从 SQL 输入直达执行、路由与结果证据。',
      text032: 'SQL解析',
      text033: '直达单条 SQL 解析、结果与历史追溯。',
      text034: 'SQL 历史',
      text035: '回查查询历史、关联 trace 和取证详情。',
      text036: '压测工作台',
      text037: '查看对比压测、阈值结论和回归守卫结果。',
      text038: '会话任务 + 报告证据',
      text039: '系统管理',
      text040: '处理 datasource、接口、规则源与消息补偿。',
      text041: '开放风险',
      ...
      text050: '压测证据边界',
      text051: '仅本次会话',
      text052: '当前仓库没有全局压测任务列表接口，首页只保留工作台入口，不伪造总通过率。',
      text053: '进入压测工作台',
      text054: '处理失败消息补偿',
      text055: '复核 dispatch 失败',
      text056: '推进待下发推荐',
      text057: '下钻重要 / 紧急 SQL',
      text058: '当前待办为空',
      text059: '当前聚合证据里没有 backlog、dispatch 失败或重要紧急 SQL。',
      text060: '查询历史',
      text061: '协同事件',
      text062: '进入',
      text063: '查看',
