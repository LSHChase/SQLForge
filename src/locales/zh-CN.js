export default {
  ...
  rewriteTrial: {
    ...
    trial: '试算',
    create: '生成改写试算',
    batchCreate: '生成批量改写试算',
    status: '试算状态',
    acceptedSql: '接收 SQL',
    skippedSql: '跳过 SQL',
    candidateGenerated: '生成候选',
    noSafeRewrite: '无安全候选',
    failed: '失败',
    sourceProblems: '来源问题',
    issueRuleLinks: '问题到规则',
    candidateSql: '候选 SQL',
    recommendationDetail: '推荐详情',
    emptyBatch: '当前批次还没有改写试算结果。',
    validationStatus: '验证状态',
    recommendationId: '推荐记录',
    eligibleSql: '可试算 SQL',
    trialedSql: '已试算',
    manualReview: '人工复核',
    validatedEquivalent: '验证等价',
    statisticsOverview: '改写试算总览',
    bySourceIssue: '改写试算来源问题',
    statisticsTitle: '改写试算统计',
    candidateGeneratedRate: '候选生成率',
    noSafeRewriteRate: '无安全候选率',
    manualReviewRate: '人工复核率',
    validationPassedRate: '验证通过率',
    issueScene: '问题场景',
    problemType: '类型',
    severity: '风险级别',
    priority: '优先级',
  ...
  recommendationCenter: {
    ...
    actions: {
      ...
      createMaterializedView: '创建真实 MV',
    ...
    materializedViewCreate: {
      title: '真实 MV 创建',
      confirmTitle: '确认创建真实 MV',
      confirmMessage: '确认在目标数据源执行 {mvName} 的 DDL 与 refresh。',
      resultEvidence: '真实 MV 创建结果',
    },
    tabs: {
      summary: '摘要',
      sqlEvidence: 'SQL 证据',
  ...
  rewriteValidation: {
    ...
    fields: {
      ...
      predicateCount: '谓词数',
      joinCount: 'JOIN 数',
      duplicateOrderByKeyCount: '重复排序键',
      duplicateGroupByKeyCount: '重复分组键',
      selectStar: '星号投影',
      repeatedSubqueryCount: '重复子查询',
      ruleChain: '规则链',
      semanticRisks: '语义风险',
      recommendationId: '推荐 ID',
      validationStatus: '验证状态',
    ...
    actions: {
      ...
      createRewriteRecord: '创建改写记录草稿',
      createValidationRun: '创建验证运行',
      refreshValidationRuns: '刷新验证运行',
      refreshRecommendations: '刷新推荐',
      openRecommendationCenter: '打开推荐结果',
      openRewriteRecord: '打开改写记录',
      openDetail: '查看详情',
      viewTaskEvidence: '查看任务证据',
      viewRawEvidence: '查看原始证据',
      copy: '复制',
      format: '格式化',
      reset: '清空结果',
    ...
    shapeChecks: {
      dynamicGenerator: '动态规则生成器',
      inputFieldLineage: '输入字段血缘',
      projectionCoverage: '投影覆盖证明',
      filterCoverage: '过滤覆盖证明',
      groupingCoverage: '分组覆盖证明',
      measureCoverage: '指标覆盖证明',
      validationMethods: '验证方法',
      staticTemplateBypassed: '绕过静态模板',
      readonlyCandidate: '只读候选 SQL',
      appliedRuleTrace: '规则追踪',
      algorithmEvidence: '算法证据',
    },
  },
  system: {
    title: '系统管理',
  ...
  inline: {
    ...
    viewsQuerySqlQueryView: {
      ...
      text094: '缓存命中',
      text095: '风险等级',
      text096: '查询已命入内存缓存。无需进行额外优化。',
      text097: '结果缓存穿透。加速改写建议已就绪，允许动态匹配运行。',
      text098: '是',
      text099: '否',
      text100: '安全',
      text101: '状态',
