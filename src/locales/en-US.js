export default {
  ...
  rewriteTrial: {
    title: 'Rewrite trial',
    trial: 'Trial',
    create: 'Generate rewrite trial',
    batchCreate: 'Generate batch rewrite trial',
    status: 'Trial status',
    acceptedSql: 'Accepted SQL',
    skippedSql: 'Skipped SQL',
    candidateGenerated: 'Candidates',
    noSafeRewrite: 'No safe rewrite',
    failed: 'Failed',
    sourceProblems: 'Source issues',
    issueRuleLinks: 'Issue-rule links',
    candidateSql: 'Candidate SQL',
    recommendationDetail: 'Recommendation detail',
    emptyBatch: 'No rewrite trial result exists for this batch.',
    validationStatus: 'Validation status',
    recommendationId: 'Recommendation',
    eligibleSql: 'Eligible SQL',
    trialedSql: 'Trialed SQL',
    manualReview: 'Manual review',
    validatedEquivalent: 'Validated equivalent',
    statisticsOverview: 'Rewrite trial overview',
    bySourceIssue: 'Rewrite trial source issues',
    statisticsTitle: 'Rewrite trial statistics',
    candidateGeneratedRate: 'Candidate rate',
    noSafeRewriteRate: 'No-safe rate',
    manualReviewRate: 'Manual review rate',
    validationPassedRate: 'Validation pass rate',
    issueScene: 'Issue scene',
    problemType: 'Type',
    severity: 'Severity',
    priority: 'Priority',
  ...
  rewriteValidation: {
    ...
    fields: {
      ...
      sourceId: 'Source ID',
      parseHistoryId: 'Parse history ID',
      historyId: 'SQL history ID',
      parseTaskId: 'Parse task ID',
      sqlFingerprint: 'SQL fingerprint',
      evidenceLevel: 'Evidence level',
      parseDepth: 'Parse depth',
      priority: 'Priority',
      issueScenes: 'Issue scenes',
      originalSql: 'Original SQL',
      recommendedSql: 'Recommended SQL',
      ...
      selectedRecommendationId: 'Selected recommendation ID',
      recommendationScore: 'Recommendation score',
      scanReduction: 'Scan reduction',
      autoApplyAllowed: 'Auto apply allowed',
      validationMethod: 'Validation method',
      comparisonStatus: 'Comparison status',
      differenceType: 'Difference type',
      ...
      tableCount: 'Object count',
      projectionCount: 'Projection count',
      predicateCount: 'Predicate count',
      joinCount: 'JOIN count',
      duplicateOrderByKeyCount: 'Duplicate order keys',
      duplicateGroupByKeyCount: 'Duplicate group keys',
      selectStar: 'SELECT *',
      repeatedSubqueryCount: 'Repeated subqueries',
      ruleChain: 'Rule chain',
      semanticRisks: 'Semantic risks',
      recommendationId: 'Recommendation ID',
      validationStatus: 'Validation status',
    ...
    actions: {
      ...
      createRewriteRecord: 'Create rewrite-record draft',
      createValidationRun: 'Create validation run',
      refreshValidationRuns: 'Refresh validation runs',
      refreshRecommendations: 'Refresh recommendations',
      openRecommendationCenter: 'Open recommendations',
      openRewriteRecord: 'Open rewrite record',
      openDetail: 'Open detail',
      viewTaskEvidence: 'View task evidence',
      viewRawEvidence: 'View raw evidence',
      copy: 'Copy',
      format: 'Format',
      reset: 'Clear result',
    ...
    shapeChecks: {
      dynamicGenerator: 'Dynamic rule generator',
      inputFieldLineage: 'Input field lineage',
      projectionCoverage: 'Projection coverage proof',
      filterCoverage: 'Filter coverage proof',
      groupingCoverage: 'Grouping coverage proof',
      measureCoverage: 'Measure coverage proof',
      validationMethods: 'Validation methods',
      staticTemplateBypassed: 'Static template bypassed',
      readonlyCandidate: 'Read-only candidate SQL',
      appliedRuleTrace: 'Rule trace',
      algorithmEvidence: 'Algorithm evidence',
    },
  },
  system: {
  ...
  inline: {
    ...
    viewsDashboardDashboardView: {
      ...
      text037: 'Review recommendation results',
    ...
    viewsQuerySqlQueryView: {
      ...
      text087: 'Expand Sidebar',
      text088: 'Collapse Sidebar',
      text089: 'Settings',
      text090: 'Tuning & Diagnostics',
      text091: 'Trace Audit',
      text092: 'Preferences',
