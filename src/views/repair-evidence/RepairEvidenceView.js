...
const __returned__ = { t, locale, route, router, form, loadingLookup, loadingDetail, lookupResults, detail, errorMessage, hasMore, nextCursor, activeFilters, isChinese, activeTraceId, matchedCount, compensationCount, reportLinkedCount, nonSuccessCount, searchCriteria, selectedSummary, detailHighlights, selectedSignals, hasDisplayValue, displayValue, formatTimestamp, isCompensationTrace, resolveLookupMode, resolveRepairSignal, loadTraceDetail, normalizeFilters, applyLookupPage, runLookup, loadMoreResults, clearLookup, buildTroubleshootingQuery, openTroubleshooting, eventHighlights, computed, onMounted, reactive, ref, get useI18n() { return useI18n }, get useRoute() { return useRoute }, get useRouter() { return useRouter }, get ROUTE_PATHS() { return ROUTE_PATHS }, get formatRuntimeError() { return formatRuntimeError }, get getGovernanceTraceDetail() { return getGovernanceTraceDetail }, get GOVERNANCE_COMPENSATION_TRACE_PREFIX() { return GOVERNANCE_COMPENSATION_TRACE_PREFIX }, get lookupGovernanceTraces() { return lookupGovernanceTraces } }
...
const _hoisted_1 = {
  class: "runtime-page",
  "data-testid": "repair-evidence-page"
}
...
const _hoisted_27 = { "data-testid": "repair-evidence-match-count" }
const _hoisted_28 = { class: "summary-card summary-card-warning" }
const _hoisted_29 = { class: "summary-card-label" }
const _hoisted_30 = { "data-testid": "repair-evidence-compensation-count" }
const _hoisted_31 = { class: "summary-card" }
const _hoisted_32 = { class: "summary-card-label" }
const _hoisted_33 = { "data-testid": "repair-evidence-report-count" }
const _hoisted_34 = { class: "summary-card summary-card-warning" }
const _hoisted_35 = { class: "summary-card-label" }
const _hoisted_36 = { "data-testid": "repair-evidence-non-success-count" }
const _hoisted_37 = {
  key: 0,
...
const _hoisted_38 = {
  ...
  "data-testid": "repair-evidence-error"
}
const _hoisted_39 = {
  key: 2,
  class: "empty-state"
...
const _hoisted_45 = { class: "trace-item-foot" }
const _hoisted_46 = { class: "trace-item-tags" }
const _hoisted_47 = {
  key: 0,
...
const _hoisted_54 = { "data-testid": "repair-evidence-detail-trace-id" }
const _hoisted_55 = { "data-testid": "repair-evidence-detail-status" }
...
const _hoisted_60 = { "data-testid": "repair-evidence-detail-service-code" }
...
const _hoisted_69 = ["data-testid"]
const _hoisted_70 = { class: "timeline-list" }
const _hoisted_71 = { class: "timeline-card-header" }
const _hoisted_72 = { class: "timeline-card-id sqlforge-code-label" }
const _hoisted_73 = { class: "timeline-card-line" }
const _hoisted_74 = { class: "timeline-card-line timeline-card-line-muted" }
const _hoisted_75 = { class: "timeline-card-meta" }
  ...
  return (_openBlock(), _createElementBlock("section", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _createElementVNode("div", null, [
        ...
        _createElementVNode("h1", _hoisted_3, _toDisplayString($setup.t('repairEvidence.title')), 1 /* TEXT */),
        _createElementVNode("p", _hoisted_4, _toDisplayString($setup.t('repairEvidence.summary')), 1 /* TEXT */)
      ]),
      _createElementVNode("p", _hoisted_5, _toDisplayString($setup.isChinese
            ...
            : 'This page calls the live governance reverse-lookup APIs and correlates failure chains, compensation traces, and report write-back evidence by trace, task, and report so the browser runtime gate extends into governance forensics.'), 1 /* TEXT */)
    ]),
    _createElementVNode("div", _hoisted_6, [
      _createElementVNode("article", _hoisted_7, [
        _createElementVNode("div", _hoisted_8, [
          _createElementVNode("div", null, [
            _cache[6] || (_cache[6] = _createElementVNode("p", { class: "section-kicker sqlforge-code-label" }, "reverse lookup", -1 /* HOISTED */)),
            _createElementVNode("h2", _hoisted_9, _toDisplayString($setup.isChinese ? '追溯条件与命中结果' : 'Lookup criteria and matched traces'), 1 /* TEXT */)
          ])
        ]),
        _createElementVNode("div", _hoisted_10, [
          _createElementVNode("label", _hoisted_11, [
            ...
            _createVNode(_component_el_input, {
              ...
              "data-testid": "repair-evidence-tenant-id"
          ...
          _createElementVNode("label", _hoisted_13, [
            ...
            _createVNode(_component_el_input, {
              ...
              "data-testid": "repair-evidence-limit"
            }, null, 8 /* PROPS */, ["modelValue"])
          ]),
          _createElementVNode("label", _hoisted_15, [
            ...
            _createVNode(_component_el_input, {
              ...
              placeholder: $setup.isChinese ? '输入 trace id 反查单条执行链' : 'Enter a trace id to reverse lookup one execution chain'
          ...
          _createElementVNode("label", _hoisted_17, [
            ...
            _createVNode(_component_el_input, {
              ...
              placeholder: $setup.isChinese ? '输入异步任务 id 追补偿证据' : 'Enter an async task id to trace compensation evidence'
            }, null, 8 /* PROPS */, ["modelValue", "placeholder"])
          ]),
          _createElementVNode("label", _hoisted_19, [
            ...
            _createVNode(_component_el_input, {
              ...
              placeholder: $setup.isChinese ? '输入报告 id 追回写与导出证据' : 'Enter a report id to trace write-back and export evidence'
            }, null, 8 /* PROPS */, ["modelValue", "placeholder"])
          ])
        ]),
        _createElementVNode("div", _hoisted_21, [
          _createVNode(_component_el_button, {
            ...
            default: _withCtx(() => [
              _createTextVNode(_toDisplayString($setup.isChinese ? '执行反查' : 'Run reverse lookup'), 1 /* TEXT */)
            ]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["loading"]),
          _createVNode(_component_el_button, {
            "data-testid": "repair-evidence-clear-lookup",
          ...
          ($setup.hasMore)
            ? (_openBlock(), _createBlock(_component_el_button, {
                ...
                default: _withCtx(() => [
                  _createTextVNode(_toDisplayString($setup.isChinese ? '加载更早结果' : 'Load older matches'), 1 /* TEXT */)
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["loading"]))
        ...
        _createElementVNode("div", _hoisted_22, [
          ...
          (!$setup.searchCriteria.length)
            ? (_openBlock(), _createElementBlock("span", _hoisted_23, _toDisplayString($setup.isChinese
                ...
                : 'Enter a trace, task, or report id and then run the lookup.'), 1 /* TEXT */))
            : _createCommentVNode("v-if", true)
        ]),
        _createElementVNode("div", _hoisted_24, [
          ...
          _createElementVNode("article", _hoisted_31, [
            _createElementVNode("span", _hoisted_32, _toDisplayString($setup.isChinese ? '报告关联 trace' : 'Report-linked traces'), 1 /* TEXT */),
            _createElementVNode("strong", _hoisted_33, _toDisplayString($setup.reportLinkedCount), 1 /* TEXT */)
          ]),
          _createElementVNode("article", _hoisted_34, [
            _createElementVNode("span", _hoisted_35, _toDisplayString($setup.isChinese ? '异常/修复链' : 'Non-success chains'), 1 /* TEXT */),
            _createElementVNode("strong", _hoisted_36, _toDisplayString($setup.nonSuccessCount), 1 /* TEXT */)
          ])
        ]),
        ($setup.hasMore)
          ? (_openBlock(), _createElementBlock("div", _hoisted_37, [
              _createElementVNode("strong", null, _toDisplayString($setup.isChinese ? '仍有更早 trace' : 'Older traces available'), 1 /* TEXT */),
        ...
        ($setup.errorMessage)
          ...
          : (!$setup.lookupResults.length)
            ? (_openBlock(), _createElementBlock("p", _hoisted_39, _toDisplayString($setup.isChinese
              ...
              : 'Matched traces render here so you can drill into the linked audit and repair timeline.'), 1 /* TEXT */))
            : _createCommentVNode("v-if", true),
            ...
            return (_openBlock(), _createElementBlock("button", {
              ...
              _createElementVNode("div", _hoisted_46, [
                ($setup.isCompensationTrace(trace.traceId))
                  ? (_openBlock(), _createElementBlock("span", _hoisted_47, _toDisplayString($setup.isChinese ? '补偿 trace' : 'Compensation trace'), 1 /* TEXT */))
                  : _createCommentVNode("v-if", true),
                ($setup.hasDisplayValue(trace.reportId))
                  ? (_openBlock(), _createElementBlock("span", _hoisted_48, _toDisplayString($setup.isChinese ? '报告回写' : 'Report write-back'), 1 /* TEXT */))
                  : _createCommentVNode("v-if", true),
                (trace.degraded)
                  ? (_openBlock(), _createElementBlock("span", _hoisted_49, _toDisplayString($setup.isChinese ? '降级恢复' : 'Degraded recovery'), 1 /* TEXT */))
                  : _createCommentVNode("v-if", true)
              ])
      ...
      _createElementVNode("article", _hoisted_50, [
        _createElementVNode("div", _hoisted_51, [
          _createElementVNode("div", null, [
            _cache[7] || (_cache[7] = _createElementVNode("p", { class: "section-kicker sqlforge-code-label" }, "repair detail", -1 /* HOISTED */)),
            _createElementVNode("h2", _hoisted_52, _toDisplayString($setup.isChinese ? '补偿与修复证据明细' : 'Compensation and repair detail'), 1 /* TEXT */)
          ])
        ]),
        (!$setup.detail && !$setup.errorMessage)
          ? (_openBlock(), _createElementBlock("p", _hoisted_53, _toDisplayString($setup.isChinese
              ...
              : 'After you select a matched trace, the lookup mode, repair signals, and audit timeline render here.'), 1 /* TEXT */))
          : _createCommentVNode("v-if", true),
        ($setup.detail)
          ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
              ...
              _createElementVNode("div", _hoisted_57, [
                ...
                _createElementVNode("div", _hoisted_61, [
                  _createElementVNode("span", _hoisted_62, _toDisplayString($setup.isChinese ? '资源标识' : 'Resource id'), 1 /* TEXT */),
                  _createElementVNode("strong", null, _toDisplayString($setup.detail.resourceId || '-'), 1 /* TEXT */)
                ]),
                _createElementVNode("div", _hoisted_63, [
                  _createElementVNode("span", _hoisted_64, _toDisplayString($setup.isChinese ? '最后发生时间' : 'Last seen at'), 1 /* TEXT */),
                  _createElementVNode("strong", null, _toDisplayString($setup.formatTimestamp($setup.detail.lastSeenAt)), 1 /* TEXT */)
                ]),
                _createElementVNode("div", _hoisted_65, [
                  _createElementVNode("span", _hoisted_66, _toDisplayString($setup.isChinese ? '异常事件数' : 'Non-success events'), 1 /* TEXT */),
              ...
              _createElementVNode("div", _hoisted_67, [
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList($setup.selectedSignals, (item) => {
                  return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("strong", {
                      "data-testid": `repair-evidence-detail-${item.key.replace(/[A-Z]/g, match => `-${match.toLowerCase()}`)}`
                ...
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList($setup.detailHighlights, (item) => {
                  return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("strong", {
                      "data-testid": `repair-evidence-detail-${item.key.replace(/[A-Z]/g, match => `-${match.toLowerCase()}`)}`
                    }, _toDisplayString($setup.displayValue(item.value)), 9 /* TEXT, PROPS */, _hoisted_69)
                  ]))
                }), 128 /* KEYED_FRAGMENT */))
              ]),
                ...
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList($setup.detail.auditEvents, (event) => {
                  return (_openBlock(), _createElementBlock("article", {
                    ...
                    _createElementVNode("div", _hoisted_71, [
                      _createElementVNode("div", null, [
                        _createElementVNode("p", _hoisted_72, _toDisplayString(event.serviceCode), 1 /* TEXT */),
                    ...
                    _createElementVNode("p", _hoisted_73, _toDisplayString($setup.isChinese ? '请求链路' : 'Request chain') + ": " + _toDisplayString(event.requestId) + " / " + _toDisplayString(event.traceId), 1 /* TEXT */),
                    _createElementVNode("p", _hoisted_74, _toDisplayString($setup.formatTimestamp(event.createTime)) + " · " + _toDisplayString(event.costMs || 0) + "ms ", 1 /* TEXT */),
...
__sfc__.__scopeId = 'data-v-bb4fa357'
__sfc__.render = render
__sfc__.__file = "src/views/repair-evidence/RepairEvidenceView.js"
