...
public class SqlOptimizationAccelerationRecommendation {
    ...
    public String getSourceSqlText() {
        return sourceSqlText;
    }

    public void setSourceSqlText(String sourceSqlText) {
        this.sourceSqlText = sourceSqlText;
    }

    public String getRecommendedSqlText() {
        return recommendedSqlText;
    }

    public void setRecommendedSqlText(String recommendedSqlText) {
        this.recommendedSqlText = recommendedSqlText;
    }
    ...
    public String getLogicalObjectKey() {
        return logicalObjectKey;
    }

    public void setLogicalObjectKey(String logicalObjectKey) {
    ...
    public Boolean getRequiresDispatch() {
        return requiresDispatch;
    }

    public void setRequiresDispatch(Boolean requiresDispatch) {
