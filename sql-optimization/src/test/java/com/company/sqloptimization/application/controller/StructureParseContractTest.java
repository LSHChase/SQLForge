...
class StructureParseContractTest {
    ...
    void shouldExposeStableStructureParseResponseContract() {
        ...
        featureSummary.setOrderByExpressionCount(Integer.valueOf(4));
        featureSummary.setDuplicateOrderByKeyCount(Integer.valueOf(1));
        featureSummary.setDuplicateGroupByKeyCount(Integer.valueOf(1));
        featureSummary.setGroupByWithoutAggregate(Boolean.FALSE);
        featureSummary.setAggregateFunctionCount(Integer.valueOf(3));
        featureSummary.setStringProjectionCount(Integer.valueOf(2));
        featureSummary.setStringConcatenationCount(Integer.valueOf(1));
        ...
        assertEquals(Integer.valueOf(4), response.getFeatureSummary().getOrderByExpressionCount());
        assertEquals(Integer.valueOf(1), response.getFeatureSummary().getDuplicateOrderByKeyCount());
        assertEquals(Integer.valueOf(1), response.getFeatureSummary().getDuplicateGroupByKeyCount());
        assertEquals(Boolean.FALSE, response.getFeatureSummary().getGroupByWithoutAggregate());
        assertEquals(Integer.valueOf(3), response.getFeatureSummary().getAggregateFunctionCount());
        assertEquals(Integer.valueOf(2), response.getFeatureSummary().getStringProjectionCount());
