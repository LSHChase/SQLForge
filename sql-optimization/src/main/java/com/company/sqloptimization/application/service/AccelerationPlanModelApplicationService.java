...
public class AccelerationPlanModelApplicationService {
    ...
    public AccelerationPlanStatusResponse buildStatusResponse(AccelerationPlan accelerationPlan) {
        return new AccelerationPlanStatusResponse(
            ...
            accelerationPlan.getActivationEvidenceJson(),
            accelerationPlan.getActivatedAt(),
            accelerationPlan.getActivatedBy(),
            accelerationPlan.getPauseEvidenceJson(),
            accelerationPlan.getPausedAt(),
            accelerationPlan.getPausedBy(),
