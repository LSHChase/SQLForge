...
public class StructureParseResponseBaseVO {
    ...
    public String getStructureAnalysisStatus() { return structureAnalysisStatus; }
    public void setStructureAnalysisStatus(String structureAnalysisStatus) { this.structureAnalysisStatus = structureAnalysisStatus; }
    public String getSyntaxStatus() { return syntaxStatus; }
    public void setSyntaxStatus(String syntaxStatus) { this.syntaxStatus = syntaxStatus; }
    ...
    public StructureParseIntentProfileVO getIntentProfile() { return intentProfile; }
    public void setIntentProfile(StructureParseIntentProfileVO intentProfile) { this.intentProfile = intentProfile; }
    public StructureParseFeatureSummaryVO getFeatureSummary() { return featureSummary; }
    public void setFeatureSummary(StructureParseFeatureSummaryVO featureSummary) { this.featureSummary = featureSummary; }
    public Map<String, Object> getAdvancedStructureProfile() { return advancedStructureProfile; }
    public void setAdvancedStructureProfile(Map<String, Object> advancedStructureProfile) { this.advancedStructureProfile = advancedStructureProfile; }
    public StructureParseResourceEstimateVO getEstimatedResourceCost() { return estimatedResourceCost; }
    public void setEstimatedResourceCost(StructureParseResourceEstimateVO estimatedResourceCost) { this.estimatedResourceCost = estimatedResourceCost; }
    public List<StructureParseRiskVO> getRiskChecklist() { return riskChecklist; }
    public void setRiskChecklist(List<StructureParseRiskVO> riskChecklist) { this.riskChecklist = riskChecklist; }
    public StructureParseQueryDateSummaryVO getQueryDateSummary() { return queryDateSummary; }
    public void setQueryDateSummary(StructureParseQueryDateSummaryVO queryDateSummary) { this.queryDateSummary = queryDateSummary; }
    ...
    public List<LogicalObjectSurface> getSurfaceObjectRefs() { return surfaceObjectRefs; }
    public void setSurfaceObjectRefs(List<LogicalObjectSurface> surfaceObjectRefs) { this.surfaceObjectRefs = surfaceObjectRefs; }
    public List<LogicalObjectSurface> getExpandedPhysicalObjectRefs() { return expandedPhysicalObjectRefs; }
    public void setExpandedPhysicalObjectRefs(List<LogicalObjectSurface> expandedPhysicalObjectRefs) { this.expandedPhysicalObjectRefs = expandedPhysicalObjectRefs; }
    ...
    public void setRewriteCandidates(List<String> rewriteCandidates) { this.rewriteCandidates = rewriteCandidates; }
    public List<StructureParseIssueVO> getIssues() { return issues; }
    public void setIssues(List<StructureParseIssueVO> issues) { this.issues = issues; }
    ...
    public PlanAnalysisVO getPlanAnalysis() { return planAnalysis; }
    public void setPlanAnalysis(PlanAnalysisVO planAnalysis) { this.planAnalysis = planAnalysis; }
