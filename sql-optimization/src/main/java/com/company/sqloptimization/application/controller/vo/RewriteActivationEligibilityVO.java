...
public class RewriteActivationEligibilityVO {
    ...
    private List<RewriteActivationEligibilityReasonVO> refusalReasons;
    ...
    public List<RewriteActivationEligibilityReasonVO> getRefusalReasons() { return refusalReasons; }
    public void setRefusalReasons(List<RewriteActivationEligibilityReasonVO> refusalReasons) { this.refusalReasons = refusalReasons; }
